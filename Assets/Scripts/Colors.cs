...
public class Colors : BaseMeshEffect
{
    ...
    public override void ModifyMesh(VertexHelper vh)
    {
        if (enabled)
        {
            ...
            Vector2 dir = ColorUtils.RotationDir(m_angle);

            if (!m_ignoreRatio)
                dir = ColorUtils.CompensateAspectRatio(rect, dir);

            ColorUtils.Matrix2x3 localPositionMatrix = ColorUtils.LocalPositionMatrix(rect, dir);
